 ...
 * @start: here is the starting index
 * @stop: this is the stopping index
 * Return: this is pointer to new buffer
 */
 ...
 * @info: here is the info struct
 * @pathstr: here is the PATH string
 * @cmd:here is  the cmd to find
